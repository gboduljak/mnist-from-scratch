...
print('nn32 - 1024 epochs, batch=64')
...
print('nn32 - 2048 epochs, batch=64')
...
print('nn32 - 1024 epochs, batch=128')
...
print('nn32 - 2048 epochs, batch=128')
...
print('nn32 - 1024 epochs, batch=256')
...
print('nn32 - 2048 epochs, batch=256')
